...
| **Exhibitor** | ✅ Create + edit — `saveExhibitorAction` `exhibitor-manager/actions.ts:32,72`; `setExhibitorStatusAction` :125 | `exhibitors` | ❌ ROADMAP `:211` lists the exhibitor webpage as to-do — correct | ❌ | Authored and shown to nobody. |
